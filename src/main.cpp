...
# define X_EN_5v  19 //ENA+(+5V) stepper motor enable , active low     Orange
//# define X_DIRgnd 4 //DIR-(DIR) axis stepper motor direction control  Blue
# define X_DIR_5v 18 //DIR+(+5v) axis stepper motor direction control  Brown
//# define X_STPgnd 6 //PUL-(PUL) axis stepper motor step control       Black
# define X_STP_5v 5 //PUL+(+5v) axis stepper motor step control       RED
